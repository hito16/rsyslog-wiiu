...
dist-src:
	@tar --exclude=*~ -cjf $(TARGET)-src-$(VERSION).tar.bz2 include  src Makefile.wiiu.mk
...
$(BUILD): $(SRCFILES)
	@[ -d $@ ] || mkdir -p $@
	@$(MAKE) --no-print-directory -C $(BUILD) -f $(CURDIR)/Makefile.wiiu.mk

#-------------------------------------------------------------------------------
clean:
	@echo clean ...
	@rm -rf $(BUILD) $(TARGET).a lib $(TARGET)-$(VERSION).tar.bz2
